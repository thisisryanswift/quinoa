...
from granola.constants import LAYOUT_MARGIN_SMALL
from granola.storage.database import Database
from granola.ui.styles import MEETING_LIST_STYLE
...
class LeftPanel(QWidget):
    ...
    # Emitted when a meeting is selected, with the recording ID
